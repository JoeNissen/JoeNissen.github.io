...
(function() {
  ...
  // Utility: get computed accent color
  function getAccent() {
  ...
  (function() {
    ...
    var snake, dir, food, score, gameOver, interval;
  ...
  (function() {
    ...
    document.getElementById('game-2048-restart').addEventListener('click', init);
    init();
  })();
